                ...
                <FormGroup action="/api/contact">
                    ...
                    <InputContainer>
                        <div>
                            ...
                            <OutlinedInput id="name" name="name" placeholder="Full Name" type="text" className="input-field" value={formData.name} onChange={(e) => {updateData(e)}}/>
                        </div>
                        <div>
                            <label htmlFor="email">Email</label>
                            <OutlinedInput id="email" name="email" placeholder="xyz@abc.com" type="text" className="input-field" value={formData.email} onChange={(e) => {updateData(e)}}/>
                        </div>
                    </InputContainer>
                    ...
                    <InputContainer>
                        <div>
                            ...
                            <OutlinedInput id="phone" name="phone" placeholder="(123) 456-7890" type="number" className="input-field" value={formData.phone} onChange={(e) => {updateData(e)}}/>
                        </div>
                        <div>
                            <label htmlFor="code">ZIP Code</label>
                            <OutlinedInput id="code" name="code" placeholder="XXXXX" type="number" className="input-field" value={formData.code} onChange={(e) => {updateData(e)}}/>
                        </div>
                    </InputContainer>
                    ...
                    <SubmitButton type="submit" onClick={submitForm}>SUBMIT</SubmitButton>
                </FormGroup>
            </UserDetails>
        </ContactUsContainer>
    )
